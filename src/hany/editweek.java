...
public class editweek extends javax.swing.JFrame {
    ...
    public editweek() throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(cmweek, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, 100, 30));
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 200, 80, 30));

        save.setBackground(new java.awt.Color(98, 113, 146));
        save.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        save.setForeground(new java.awt.Color(255, 255, 255));
        save.setText("تعديل اسبوع");
        save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveActionPerformed(evt);
            }
        });
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, 150, 40));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        try
               {
                 String sqla = "UPDATE hany.buy SET week = '"+cmweek.getSelectedItem().toString()+"'"
                  ...
                  pst.executeUpdate();
                  JOptionPane.showMessageDialog(this, "تم تعديل الاسبوع");
