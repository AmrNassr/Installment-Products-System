...
public class lateday extends javax.swing.JFrame {
 ...
 int dayy = cal.get(Calendar.DAY_OF_MONTH)-1;
    ...
    private void initComponents() {
        ...
        save.setText("مستحقات اليوم السابق");
        save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveActionPerformed(evt);
            }
        });
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 230, 40));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
           ...
           String dayy=day1.getText();
            InputStream in=null;
            try {
                in = this.getClass().getResourceAsStream("/reports/lateamount.jasper");
                String reportpath= "\\\\192.168.1.15\\sadam\\lateamount.jasper";
