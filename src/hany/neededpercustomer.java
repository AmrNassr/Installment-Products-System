...
public class neededpercustomer extends javax.swing.JFrame {
 ...
 int dayy = cal.get(Calendar.DAY_OF_MONTH);
    ...
    private void initComponents() {
        ...
        jPanel1.add(cancle, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 170, 80, 30));

        save.setBackground(new java.awt.Color(98, 113, 146));
        save.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        save.setForeground(new java.awt.Color(255, 255, 255));
        save.setText("مستحقات مورد");
        save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveActionPerformed(evt);
            }
        });
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 210, 40));

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("اسم المورد");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, 110, -1));

        cmtype.setEditable(true);
        cmtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        jPanel1.add(cmtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 260, 30));
        ...
        jPanel1.add(txttotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 180, -1, -1));
    ...
    String typee=cmtype.getSelectedItem().toString();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/neededlogspercustomer.jasper");
          String reportpath= "\\\\192.168.1.15\\sadam\\neededlogspercustomer.jasper";
...
public void msroffat()
   {
        try {
             String sql="SELECT name  FROM hany.needed ";
...
public void totalllll()
   {
        try {
             String sql="SELECT total  FROM hany.needed where name='"+cmtype.getSelectedItem().toString()+"' ";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
