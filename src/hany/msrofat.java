...
public final class msrofat extends javax.swing.JInternalFrame {
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
                       ...
                       try
        {
             int amountt = Integer.parseInt(amount.getText());
                ...
                else
                {
                    ...
                    if(dialogResult == 0) {
                        try{
                            String sql = "INSERT INTO hany.msrofat (employee,kind,type,amount,comment,date,fulldatee) VALUES"
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
                           ...
                           try {
                String sql = "DELETE FROM hany.msrofat WHERE (fulldatee = '"+cmtype1.getSelectedItem().toString()+"');";
                pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
                pst.execute();
  ...
  if( typename.getText().trim().isEmpty() )
            ...
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO hany.types (name,employee) VALUES"
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        ...
        try
        {
            ...
            String sqll="SELECT distinct fulldatee FROM hany.msrofat  where 1=1 ";
        ...
        try {
            ...
            String sql="SELECT * FROM hany.msrofat where 1=1 ";
...
public void msroffat()
   {
        try {
             String sql="SELECT name  FROM hany.types ";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
 ...
 public void comboxfromcombo1()
      {
            ...
            public void itemStateChanged(ItemEvent event) {
                ...
                Object item = event.getItem();
                 ...
                 try {
             String sql="SELECT * FROM hany.msrofat where fulldatee='"+cmtype1.getSelectedItem().toString()+"'";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
 ...
 public void comboxfromcombo2()
      {
            ...
            public void itemStateChanged(ItemEvent event) {
                ...
                Object item = event.getItem();
                 ...
                 try {
             String sql="SELECT * FROM hany.types where name='"+cmtype.getSelectedItem().toString()+"'";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
