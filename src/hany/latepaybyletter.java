...
public class latepaybyletter extends javax.swing.JFrame {
 ...
 Calendar cal = new GregorianCalendar();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("الحرف");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 130, 70, 30));

        letter.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel1.add(letter, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 60, 30));
        ...
        jPanel1.add(cancle, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 80, 40));

        jLabel9.setBackground(new java.awt.Color(255, 255, 255));
        jLabel9.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("الي");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 30, 50, -1));

        jLabel11.setBackground(new java.awt.Color(255, 255, 255));
        jLabel11.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("من");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 80, 50, 30));
        ...
        save.setText("تاخير الدفع");
        save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveActionPerformed(evt);
            }
        });
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 130, 40));
    ...
    String to=year2.getText()+"-"+month2.getText()+"-"+day2.getText();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/lateamountbyletter.jasper");
          String reportpath= "\\\\192.168.1.15\\sadam\\msrofat.jasper";
    Map<String,Object> para = new HashMap<String,Object>();
            para.put("from",from );
            para.put("to",to );
            para.put("fromday",day.getText() );
            para.put("today",day2.getText() );
            para.put("letter",letter.getText()+"%" );
    ...
    public javax.swing.JTextField letter;
