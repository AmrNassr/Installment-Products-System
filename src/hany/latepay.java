...
public class latepay extends javax.swing.JFrame {
 ...
 Calendar cal = new GregorianCalendar();
    ...
    private void initComponents() {
        ...
        jPanel1.add(cancle, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 210, 80, 30));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 130, 40));
    ...
    String to=year2.getText()+"-"+month2.getText()+"-"+day2.getText();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/lateamountpay.jasper");
