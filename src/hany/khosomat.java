 ...
 * @author amnassar
 */
public class khosomat extends javax.swing.JFrame {
    ...
    public khosomat() throws ParseException {
        initComponents();
        comboxfromcombo1();
    ...
    private void initComponents() {
        ...
        totalx = new javax.swing.JTextField();
        ...
        seriall = new javax.swing.JLabel();
        date = new javax.swing.JLabel();
        total = new javax.swing.JLabel();
        pagee = new javax.swing.JLabel();
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 60, -1));

        totalx.setEditable(false);
        totalx.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jPanel1.add(totalx, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 90, 30));
        ...
        jPanel1.add(cmname, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, 260, 30));
        ...
        jPanel1.add(save1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 90, 30));

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("المنتج");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, 60, -1));
        ...
        jPanel1.add(cmitem, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, 260, 30));

        person2.setEditable(false);
        person2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jPanel1.add(person2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 150, 150, 30));

        jLabel17.setBackground(new java.awt.Color(255, 255, 255));
        jLabel17.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("الخصم");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, 70, 30));

        amount.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jPanel1.add(amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 200, 70, 30));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, 140, 40));
        ...
        seriall.setText("jLabel2");
        jPanel1.add(seriall, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, -1, -1));

        date.setText("jLabel2");
        jPanel1.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, -1, -1));

        total.setText("jLabel2");
        jPanel1.add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, -1, -1));

        pagee.setText("jLabel2");
        jPanel1.add(pagee, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, -1, -1));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        double totall = Double.parseDouble(totalx.getText());
        double amountt = Double.parseDouble(amount.getText());
        if (amountt > totall) {
            JOptionPane.showMessageDialog(this, "المبلغ المخصوم اكبر من المتبقي");
            amount.requestFocus();
        }
        else {
            ...
            if (dialogResult == 0) {
                ...
                try {
                    ...
                    String sqll = "INSERT INTO hany.khosomat (page,serial,name,item,date,fulldate,amount) VALUES"
                            + " ('"+pagee.getText()+"','" + seriall.getText() + "','" + cmname.getSelectedItem().toString() + "','" + itemmq + "',"
                            + "'" + datee + "','" + fulldatee + "','" + amount.getText() + "')";
                    pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
                    pst.execute();
                    String sqla = "UPDATE hany.buy SET total =total-" + amount.getText() + ""
                            + " WHERE item='" +itemmq + "' and name='" + cmname.getSelectedItem().toString() + "' and serial = '" + seriall.getText() + "'";
    ...
    private javax.swing.JLabel pagee;
    private javax.swing.JTextField person2;
    private javax.swing.JButton save;
    private javax.swing.JButton save1;
    private javax.swing.JLabel seriall;
    private javax.swing.JLabel total;
    private javax.swing.JTextField totalx;
        ...
        cmitem.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent event) {
                ...
                try {
                    ...
                    rs = pst.executeQuery();
                    if (rs.next()) {
                        totalx.setText(rs.getString("total"));
                        seriall.setText(rs.getString("serial"));
                        person2.setText(rs.getString("person2"));
                        pagee.setText(rs.getString("page"));
                    }
