...
public class peopletype extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(cancle, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 80, 30));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 160, 40));

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("نوع ");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 70, 180, -1));

        cmtype.setEditable(true);
        cmtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "شنطة", "شهرية", "شنطه و شهرية" }));
        jPanel1.add(cmtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 260, 30));
...
if(cmtype.getSelectedItem().toString().equals("شهرية") || cmtype.getSelectedItem().toString().equals("شنطه و شهرية"))
{
     InputStream in=null;
      try {
          
          String typee=cmtype.getSelectedItem().toString();
          in = this.getClass().getResourceAsStream("/reports/peoplemonth.jasper");
          String reportpath= "\\\\192.168.1.15\\sadam\\peoplemonth.jasper";
    ...
    String typee=cmtype.getSelectedItem().toString();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/people.jasper");
          String reportpath= "\\\\192.168.1.15\\sadam\\people.jasper";
    Map<String,Object> para = new HashMap<String,Object>();
            para.put("type",typee );
...
public void msroffat()
   {
        try {
             String sql="SELECT name  FROM gazar.types ";
