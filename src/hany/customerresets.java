...
public class customerresets extends javax.swing.JFrame {
    ...
    public customerresets() throws ParseException {
        initComponents();
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        save.setText("متابعة عميل");
        save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveActionPerformed(evt);
            }
        });
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, 140, 40));
    ...
    in = this.getClass().getResourceAsStream("/reports/customerItem.jasper");
                String reportpath= "\\\\192.168.1.15\\sadam\\customerItem.jasper";
