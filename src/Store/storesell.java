  ...
  tablelord();
    ...
    private void initComponents() {
        ...
        tdetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "التاريخ", "العدد", "السعر", "الصفحة", "اسم المنتج", "اسم العميل", "id"
            }
        ));
    ...
    private void delete3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete3ActionPerformed
        ...
        else
        {
         try {
             ...
             pst.executeUpdate();       
              String sql = "DELETE FROM hany.sell WHERE id='"+serialid1.getText()+"'";
                    pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
                    pst.execute();
                    String sqll = "DELETE FROM hany.storeitemlogs WHERE name='"+xitem.getText()+"' and type='كاش' and number='"+xnumber.getText()+"' and date='"+datee+"'";
             ...
             Logger.getLogger(storesell.class.getName()).log(Level.SEVERE, null, ex);
         }
        }
    ...
    private void save2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save2ActionPerformed
        ...
        int dialogButton = JOptionPane.YES_NO_OPTION;
                        ...
                        if(dialogResult == 0) {
                            ...
                            try{
                               String sqll331 = "INSERT INTO hany.sell (name,item,number,date,fulldate,price,total,page) "
                                              + "VALUES('"+name2.getText()+"','"+cmitem.getSelectedItem().toString()+"','"+number1.getText()+"',"
                                       + "'"+datee+"','"+fulldatee+"','"+price.getText()+"','"+totall+"','"+page1.getText()+"')";
                                    ...
                                    String sqla1d = "UPDATE hany.storeitemlist SET number =number-"+number1.getText()+" WHERE  name='"+cmitem.getSelectedItem().toString()+"'";
                                     pst=(PreparedStatement) DBConnect.con.prepareStatement(sqla1d);
                                      ...
                                      String sqll33 = "INSERT INTO hany.storeitemlogs (name,supplier,number,type,date,fulldate,price) "
                                              + "VALUES('"+cmitem.getSelectedItem().toString()+"','"+name2.getText()+"','"+number1.getText()+"','كاش','"+datee+"','"+fulldatee+"','"+price.getText()+"')";
...
{
    try {
           String sqll = "SELECT * FROM hany.sell where date = '"+datee+"' order by id DESC ";
              pst=(PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs=pst.executeQuery();
