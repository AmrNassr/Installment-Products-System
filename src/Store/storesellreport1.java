...
public class storesellreport1 extends javax.swing.JFrame {
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        save.setText("تقرير البيع التفصيلي");
        save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveActionPerformed(evt);
            }
        });
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 210, 40));
    ...
    String to=year2.getText()+"-"+month2.getText()+"-"+day2.getText();
     InputStream in=null;
      try {
           ...
           in = this.getClass().getResourceAsStream("/reports/storeselldetails.jasper");
          String reportpath= "\\\\192.168.1.15\\sadam\\storeselldetails.jasper";
