 ...
 * @author amnassar
 */
public final class storesell1 extends javax.swing.JInternalFrame {
    ...
    public storesell1( )throws IOException {
        initComponents();
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
  ...
  tablelord();
    ...
    private void initComponents() {
        ...
        xnumber = new javax.swing.JLabel();
        xname = new javax.swing.JLabel();
        xitem = new javax.swing.JLabel();
        ...
        jLabel26.setText("الاسم");
        jPanel13.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 130, 60, 30));

        namee.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        namee.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel13.add(namee, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, 250, 30));
        ...
        tdetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "التاريخ", "العدد", "السعر", "مجموع", "اسم المنتج", "اسم العميل", "id"
            }
        ));
        ...
        jPanel13.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 60, 70, -1));

        cmname.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "النقل العام" }));
        ...
        jPanel13.add(cmname, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, 270, 30));

        jLabel32.setBackground(new java.awt.Color(255, 255, 255));
        jLabel32.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel32.setText("العدد");
        jPanel13.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 230, 60, 30));
        ...
        jPanel13.add(t6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 650, 180, 30));
        ...
        jPanel13.add(cmvisa1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 640, 120, 30));
        ...
        jPanel13.add(t5, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 650, 170, 30));
        ...
        xnumber.setText("jLabel1");
        jPanel13.add(xnumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 510, -1, -1));

        xname.setText("jLabel1");
        jPanel13.add(xname, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 520, -1, -1));

        xitem.setText("jLabel1");
        jPanel13.add(xitem, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 520, -1, -1));
    ...
    private void tdetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tdetailsMouseClicked
        ...
        xname.setText(tmodel.getValueAt(selectrowindex, 5).toString());
        xitem.setText(tmodel.getValueAt(selectrowindex, 4).toString());
        xnumber.setText(tmodel.getValueAt(selectrowindex, 1).toString());
    ...
    private void delete3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete3ActionPerformed
        ...
        if(serialid1.getText().toString().trim().isEmpty())
        {
        }
        else
        {
         try {
             String sqla1d = "UPDATE hany.storeitemlist SET number =number+"+xnumber.getText()+" WHERE  name='"+xitem.getText()+"'";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sqla1d);
             pst.executeUpdate();       
              String sql = "DELETE FROM hany.other WHERE id='"+serialid1.getText()+"'";
                    pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
                    pst.execute();
                    String sqll = "DELETE FROM hany.storeitemlogs WHERE name='"+xitem.getText()+"' and  type ='خارج' and number='"+xnumber.getText()+"' and date='"+datee+"'";
                    pst=(PreparedStatement) DBConnect.con.prepareStatement(sqll);
                    pst.execute();
                    tablelord();
                    JOptionPane.showMessageDialog(this, " تم مسح العمليه");
             clear();
         } catch (SQLException ex) {
             Logger.getLogger(storesell1.class.getName()).log(Level.SEVERE, null, ex);
         }
        }
    ...
    private void save2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save2ActionPerformed
        ...
        int dialogButton = JOptionPane.YES_NO_OPTION;
                        ...
                        if(dialogResult == 0) {
                            ...
                            try{
                               String sqll331 = "INSERT INTO hany.other (name,supplier,item,number,date,fulldate,price,total) "
                                              + "VALUES('"+nameee+"','"+cmname.getSelectedItem().toString()+"','"+cmitem.getSelectedItem().toString()+"','"+number1.getText()+"',"
                                       + "'"+datee+"','"+fulldatee+"','"+price.getText()+"','"+totall+"')";
                                pst = (PreparedStatement)DBConnect.con.prepareStatement(sqll331);
                                pst.execute(); 
                                    String sqla1d = "UPDATE hany.storeitemlist SET number =number-"+number1.getText()+" WHERE  name='"+cmitem.getSelectedItem().toString()+"'";
                                     pst=(PreparedStatement) DBConnect.con.prepareStatement(sqla1d);
                                      pst.executeUpdate();
                                      String sqll33 = "INSERT INTO hany.storeitemlogs (othername,name,supplier,number,type,date,fulldate,price) "
                                              + "VALUES('"+nameee+"','"+cmitem.getSelectedItem().toString()+"','"+cmname.getSelectedItem().toString()+"','"+number1.getText()+"','خارج','"+datee+"','"+fulldatee+"','"+price.getText()+"')";
    ...
    private javax.swing.JLabel xitem;
    private javax.swing.JLabel xname;
    private javax.swing.JLabel xnumber;
    // End of variables declaration//GEN-END:variables

    public void tablelord()
{
    try {
           String sqll = "SELECT * FROM hany.other where date = '"+datee+"' order by id DESC ";
              pst=(PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs=pst.executeQuery();
    ...
    public void clear()
{
   ...
   {
        try {
             String sql="SELECT name  FROM hany.storeitemlist ";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
   ...
   {
        try {
             String sql="SELECT * FROM hany.storecompany";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
                String name = rs.getString("name");
