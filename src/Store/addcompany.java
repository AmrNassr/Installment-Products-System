...
public class addcompany extends javax.swing.JFrame {
    ...
    public addcompany() throws ParseException {
        initComponents();
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
         ...
         String namee = name.getText();
            ...
            {
                JOptionPane.showMessageDialog(this, " من فضلك ادخل اسم الشركة");
            }
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO hany.storecompany (name) VALUES ('"+namee+"')";
                        pst = (PreparedStatement)DBConnect.con.prepareStatement(sql);
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "تم اضافه الشركة بنجاح");
                        name.setText("");
                        
                    }
                    catch(Exception e ){
                        JOptionPane.showMessageDialog(null,"الشركة موجود من قبل");
                    }
